package com.github.tanxinzheng.module.fss.service.config;

import com.github.tanxinzheng.module.fss.service.*;
...
@ConditionalOnProperty(prefix = "storage", value = "enable", matchIfMissing = true)
