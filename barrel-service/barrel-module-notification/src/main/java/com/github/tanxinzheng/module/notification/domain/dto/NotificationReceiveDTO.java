...
@Data
@ApiModel(value = "通知接收")
public class NotificationReceiveDTO extends BaseModel implements Serializable {
    /** 物理主键 */
    ...
    @Length(max = 32, message = "通知主键字符长度限制[0,32]")
    ...
    /** 接收人主键 */
    @NotBlank(message = "接收人主键为必填项")
    @Length(max = 32, message = "接收人主键字符长度限制[0,32]")
